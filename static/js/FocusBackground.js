...
function start() {
    ...
    // load textures
    const albTexture = __loadTexture(gl, "/static/png/render_albedo.png");
    const depthTexture = __loadTexture(gl, "/static/png/render_depth.png");
    const highTexture = __loadTexture(gl, "/static/png/render_high.png");
